...
class JeiCookerRecipeWrapper implements ICraftingRecipeWrapper {

    private final JeiCookerRecipe recipe;

    public JeiCookerRecipeWrapper(JeiCookerRecipe recipe) {
        this.recipe = recipe;
    }
