...
public class MultiBlockCableHelper {
    ...
    public static <T extends IMultiBlock> int addBlockToNetwork(MultiBlockNetwork<T> network, CableType type, CableSubType subType, int networkId, World world, BlockPos thisCoord) {
    ...
    public static <T extends IMultiBlock> void removeBlockFromNetwork(MultiBlockNetwork<T> network, CableType type, CableSubType subType, int networkId, World world, BlockPos thisCoord) {
