...
public class BundleISBM implements ISmartBlockModel {
    ...
    public class BundleBakedModel implements IBakedModel {
        ...
        public BundleBakedModel(List<CableSectionRender> cables) {
            hoseSprite = Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite(AquaMunda.MODID + ":blocks/hose");
            blackCableSprite = Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite(AquaMunda.MODID + ":blocks/blackcable");
            elecCableSprite = Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite(AquaMunda.MODID + ":blocks/eleccable");
            this.cables = cables;
        }
